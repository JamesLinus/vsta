...
struct screen {
	...
	uchar s_attrib;		/* current attribute setting */
	ushort s_blank;		/* current attribute, blank */
	ulong   s_blankl;	/* two blanks in unsigned int */
};
...
#define CURSCREEN() (&screens[curscreen])
/*
...
extern void clear_screen(char *, ulong blank);
